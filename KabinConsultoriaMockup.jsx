...
const blogPostsEs = [
  { slug: "cierre-mes-fiscal", category: "Fiscal", date: "18 Jun 2026", read: "4 min", image: "/carlos-muza-hpjSkU2UYSU-unsplash.webp", title: "Que revisar antes de cerrar el mes fiscal", text: "Una guia practica para ordenar facturas, pagos, deducciones y pendientes antes de presentar informacion contable.", body: ["Antes del cierre conviene conciliar ingresos, egresos y movimientos bancarios. Las diferencias pequeñas que se dejan para después suelen convertirse en aclaraciones, recargos o decisiones tomadas con información incompleta.", "Revisa que cada comprobante corresponda al periodo, tenga soporte y esté clasificado correctamente. También identifica pagos pendientes, notas de crédito, anticipos y operaciones que requieren seguimiento antes de presentar declaraciones.", "Un cierre ordenado termina con una lista breve de pendientes, responsables y fechas. Esa disciplina permite anticipar obligaciones, cuidar el flujo de efectivo y entregar información más confiable a la dirección."] },
  { slug: "indicadores-salud-empresa", category: "Finanzas", date: "05 Jun 2026", read: "3 min", image: "/blake-wisz-GFrBMipOd_E-unsplash.webp", title: "Indicadores simples para entender la salud de tu empresa", text: "Margen, flujo, obligaciones y reservas: cuatro lecturas que ayudan a tomar mejores decisiones.", body: ["Facturar más no siempre significa operar mejor. El margen muestra cuánto valor conserva la empresa después de cubrir sus costos y ayuda a detectar productos, clientes o procesos que consumen rentabilidad.", "El flujo de efectivo revela si el negocio puede pagar nómina, proveedores e impuestos en el momento correcto. Conviene observarlo junto con las cuentas por cobrar y las obligaciones de los próximos meses.", "Una reserva operativa y un tablero sencillo permiten decidir con menos improvisación. Lo importante no es acumular indicadores, sino revisar periódicamente aquellos que explican liquidez, rentabilidad y exposición al riesgo."] },
  { slug: "retiro-seguros-patrimonio", category: "Patrimonio", date: "22 May 2026", read: "5 min", image: "/jakub-zerdzicki-LNnmSumlwO4-unsplash.webp", title: "Retiro, seguros y patrimonio: por donde empezar", text: "Como integrar proteccion financiera y ahorro sin perder de vista el impacto fiscal.", body: ["Una estrategia patrimonial comienza por proteger el ingreso y las responsabilidades actuales. Antes de elegir un producto, conviene dimensionar dependientes, deudas, gastos médicos potenciales y continuidad familiar o empresarial.", "El ahorro para el retiro necesita una meta, un plazo y una aportación sostenible. Los beneficios fiscales pueden mejorar el resultado, pero deben evaluarse junto con la liquidez, las comisiones y las condiciones de permanencia.", "Seguros, ahorro e inversión cumplen funciones distintas. Integrarlos dentro de una misma conversación permite evitar duplicidades, cubrir riesgos prioritarios y construir patrimonio con una visión de largo plazo."] },
];
...
const blogPostsEn = [
  { slug: "monthly-tax-closing", category: "Tax", date: "Jun 18, 2026", read: "4 min", image: "/carlos-muza-hpjSkU2UYSU-unsplash.webp", title: "What to review before monthly tax closing", text: "A practical guide to organize invoices, payments, deductions, and accounting pending items.", body: ["Before closing the month, reconcile income, expenses, and bank movements. Small differences left unresolved often become clarification requests, surcharges, or decisions based on incomplete information.", "Confirm that each invoice belongs to the period, has proper support, and is classified correctly. Identify pending payments, credit notes, advances, and transactions that need follow-up before filing.", "A reliable close ends with a short list of pending items, owners, and dates. This discipline helps anticipate obligations, protect cash flow, and provide management with more dependable information."] },
  { slug: "business-health-indicators", category: "Finance", date: "Jun 5, 2026", read: "3 min", image: "/blake-wisz-GFrBMipOd_E-unsplash.webp", title: "Simple indicators to understand business health", text: "Margin, cash flow, obligations, and reserves: four readings that support better decisions.", body: ["Higher sales do not always mean a healthier operation. Margin shows how much value the company retains after costs and helps identify products, clients, or processes that erode profitability.", "Cash flow reveals whether the business can pay payroll, suppliers, and taxes on time. Review it alongside receivables and obligations due over the next several months.", "An operating reserve and a simple dashboard support less reactive decisions. The goal is not to collect many metrics, but to review those that explain liquidity, profitability, and risk exposure."] },
  { slug: "retirement-insurance-wealth", category: "Wealth", date: "May 22, 2026", read: "5 min", image: "/jakub-zerdzicki-LNnmSumlwO4-unsplash.webp", title: "Retirement, insurance, and wealth: where to start", text: "How to integrate financial protection and savings while keeping tax impact in view.", body: ["A wealth strategy begins by protecting current income and responsibilities. Before selecting a product, assess dependents, debt, potential medical expenses, and family or business continuity needs.", "Retirement savings require a goal, a time horizon, and a sustainable contribution. Tax benefits may improve outcomes, but they should be evaluated together with liquidity, fees, and holding conditions.", "Insurance, savings, and investments serve different purposes. Considering them together helps avoid duplication, cover priority risks, and build wealth with a long-term perspective."] },
];
                ...
                {t.blogPosts.map((post) => (
                  <article key={post.title} className="group overflow-hidden rounded-[1.5rem] border border-emerald-950/10 bg-white shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-emerald-950/15">
                    <div className="relative h-56 overflow-hidden">
                      <img src={post.image} alt="" loading="lazy" decoding="async" className="h-full w-full object-cover transition duration-500 group-hover:scale-105" />
              ...
              <div className="mx-auto max-w-5xl px-5 lg:px-8">
                ...
                <div className="overflow-hidden rounded-[2rem] bg-white shadow-2xl shadow-slate-900/10">
                  <div className="relative h-72 overflow-hidden sm:h-[430px]">
                    <img src={post.image} alt="" fetchPriority="high" decoding="async" className="h-full w-full object-cover" />
